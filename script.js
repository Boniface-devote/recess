...
function DisplayFriends(){
    let div = document.getElementById("friendsOn")
    div.innerHTML = ""//clear the added in data
...
function DisplayIntersets(){
    let div = document.querySelector(".interests")
...
function updateInterests(){
    let div = document.querySelector(".interests")
    var text = document.getElementById("inputedText")
    var interest = document.getElementById("userInterest")

    if(text.value.trim() == ""){
        alert("please enter in a valid interest")
    }
    else{
        interest.innerText = text.value;
        text.value = ""
    }
}